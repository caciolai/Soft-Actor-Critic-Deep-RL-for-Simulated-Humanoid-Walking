...
def handle_parser():
    ...
    parser.add_argument("--max_episode_steps", type=int, default=1000, metavar="INT",
                        help="Maximum number of timesteps per episode (default: 1e3)")
    ...
    parser.add_argument("--load_policy", type=str, default=None, metavar="PATH",
                        help="Path of Policy network parameters (default: None)")

    parser.add_argument("--load_q_function", type=str, default=None, metavar="PATH",
                        help="Path of (both) Q function network parameters (default: None)")

    parser.add_argument("--load_value_function", type=str, default=None, metavar="PATH",
